...
/** Eleventy + passthrough static site (merged into portal-static/dist with React app in CI). */
const outputRoot = process.env.ELEVENTY_OUTPUT_DIR || 'content-dist';

export default async function(eleventyConfig) {
  /** URL prefix for links in Nunjucks (same value as config.pathPrefix; separate name avoids data cascade clashes). */
  eleventyConfig.addGlobalData('amrUrlPrefix', pathPrefix);
